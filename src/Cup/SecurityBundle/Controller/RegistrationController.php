    ...
    public function registerAction(Request $request)
    {
        ...
        if ('POST' === $request->getMethod()) {
            ...
            /*else
            {
                ...
                return $this->render('CupSecurityBundle:Default:login.html.twig', array(
    ...
    public function confirmAction(Request $request, $token)
    {
    	...
    	if (null === $user) {
    		...
    		**************************************/
    		...
    		//return $this->container->get('templating')->renderResponse('FOSUserBundle:Registration:link_error.html.twig');
    		
    		return $this->render('FOSUserBundle:Registration:link_error.html.twig');
